...
echo "auto-generated by afni_proc.py, Sun Aug 16 20:27:16 2020"
echo "(version 7.12, April 14, 2020)"
echo "execution started: `date`"

# to execute via tcsh: 
#   tcsh -xef FA04_Preproc_fMRI_NoRICOR_FIR.P001.015.sh |& tee output.FA04_Preproc_fMRI_NoRICOR_FIR.P001.015.sh
# to execute via bash: 
#   tcsh -xef FA04_Preproc_fMRI_NoRICOR_FIR.P001.015.sh 2>&1 | tee output.FA04_Preproc_fMRI_NoRICOR_FIR.P001.015.sh
...
set output_dir = /data/SFIM_FlipAngle/PRJ_FAConn//PrcsData/P001/D03_Preproc_NoRICOR_FIR_015
...
3dcopy                                                                           \
    /data/SFIM_FlipAngle/PRJ_FAConn/PrcsData/P001/D01_Anatomical/anatSS.P001.nii \
    $output_dir/anatSS.P001

# copy over the external align_epi_anat.py EPI volume
3dbucket -prefix $output_dir/ext_align_epi \
    '/data/SFIM_FlipAngle/PRJ_FAConn//PrcsData/P001/D00_OriginalData/P001_fMRI_015.RefVol.bc+orig[0]'

# copy anatomical follower datasets into the results dir
3dcopy                                                                            \
    /data/SFIM_FlipAngle/PRJ_FAConn/PrcsData/P001/D00_OriginalData/P001_Anat+orig \
    $output_dir/copy_af_anat_w_skull

# copy external -tlrc_NL_warped_dsets datasets
3dcopy                                                                                \
    /data/SFIM_FlipAngle/PRJ_FAConn/PrcsData/P001/D01_Anatomical/anatQQ.P001.nii      \
    $output_dir/anatQQ.P001
3dcopy                                                                                \
    /data/SFIM_FlipAngle/PRJ_FAConn/PrcsData/P001/D01_Anatomical/anatQQ.P001.aff12.1D \
    $output_dir/anatQQ.P001.aff12.1D
3dcopy                                                                                \
    /data/SFIM_FlipAngle/PRJ_FAConn/PrcsData/P001/D01_Anatomical/anatQQ.P001_WARP.nii \
    $output_dir/anatQQ.P001_WARP.nii

# ============================ auto block: tcat ============================
# apply 3dTcat to copy input dsets to results dir,
# while removing the first 0 TRs
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat                   \
    /data/SFIM_FlipAngle/PRJ_FAConn/PrcsData/P001/D00_OriginalData/P001_fMRI_015+orig'[0..$]'
...
# (new anat will be aligned and stripped, anatSS.P001_al_keep+orig)
align_epi_anat.py -anat2epi -anat anatSS.P001+orig   \
       -suffix _al_keep                              \
...
# warped anat     : anatQQ.P001+tlrc
# affine xform    : anatQQ.P001.aff12.1D
# non-linear warp : anatQQ.P001_WARP.nii
...
3dcopy anatSS.P001_al_keep+orig anat_final.$subj
...
3dNwarpApply -source copy_af_anat_w_skull+orig                                \
             ...
             -ainterp wsinc5 -nwarp anatQQ.P001_WARP.nii anatQQ.P001.aff12.1D \
             anatSS.P001_al_keep_mat.aff12.1D                                 \
...
3dresample -master full_mask.$subj+orig -input anatSS.P001_al_keep+orig \
...
if ( -e @ss_review_basic ) then
    ...
    echo "\nconsider running: \n\n    afni_open -b /data/SFIM_FlipAngle/PRJ_FAConn//PrcsData/P001/D03_Preproc_NoRICOR_FIR_015/QC_$subj/index.html\n"
endif
...
#
# afni_proc.py -subj_id P001 -copy_anat                                                                 \
#     /data/SFIM_FlipAngle/PRJ_FAConn//PrcsData/P001/D01_Anatomical/anatSS.P001.nii                     \
#     -anat_has_skull no -anat_follower anat_w_skull anat                                               \
#     /data/SFIM_FlipAngle/PRJ_FAConn//PrcsData/P001/D00_OriginalData/P001_Anat+orig                    \
#     -dsets                                                                                            \
#     /data/SFIM_FlipAngle/PRJ_FAConn//PrcsData/P001/D00_OriginalData/P001_fMRI_015+orig.HEAD           \
...
#     /data/SFIM_FlipAngle/PRJ_FAConn//PrcsData/P001/D03_Preproc_NoRICOR_FIR_015                        \
#     -script FA04_Preproc_fMRI_NoRICOR_FIR.P001.015.sh -volreg_compute_tsnr                            \
